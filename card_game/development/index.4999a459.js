...
refresh.addEventListener("click", function() {
    ...
    if (card1 == 0) c1.classList.add("vcard0");
    if (card1 == 1) c1.classList.add("vcard1");
    if (card1 == 2) c1.classList.add("vcard2");
    if (card1 == 3) c1.classList.add("vcard3");
    if (card1 == 4) c1.classList.add("vcard4");
    if (card1 == 5) c1.classList.add("vcard5");
    if (card1 == 6) c1.classList.add("vcard6");
    if (card1 == 7) c1.classList.add("vcard7");
    if (card1 == 8) c1.classList.add("vcard8");
    if (card1 == 9) c1.classList.add("vcard9");
    if (card1 == 10) c1.classList.add("vcard10");
    if (card2 == 0) c2.classList.add("vcard0");
    if (card2 == 1) c2.classList.add("vcard1");
    if (card2 == 2) c2.classList.add("vcard2");
    if (card2 == 3) c2.classList.add("vcard3");
    if (card2 == 4) c2.classList.add("vcard4");
    if (card2 == 5) c2.classList.add("vcard5");
    if (card2 == 6) c2.classList.add("vcard6");
    if (card2 == 7) c2.classList.add("vcard7");
    if (card2 == 8) c2.classList.add("vcard8");
    if (card2 == 9) c2.classList.add("vcard9");
    if (card2 == 10) c2.classList.add("vcard10");
    if (card3 == 0) c3.classList.add("vcard0");
    if (card3 == 1) c3.classList.add("vcard1");
    if (card3 == 2) c3.classList.add("vcard2");
    if (card3 == 3) c3.classList.add("vcard3");
    if (card3 == 4) c3.classList.add("vcard4");
    if (card3 == 5) c3.classList.add("vcard5");
    if (card3 == 6) c3.classList.add("vcard6");
    if (card3 == 7) c3.classList.add("vcard7");
    if (card3 == 8) c3.classList.add("vcard8");
    if (card3 == 9) c3.classList.add("vcard9");
    if (card3 == 10) c3.classList.add("vcard10");
    if (card4 == 0) c4.classList.add("vcard0");
    if (card4 == 1) c4.classList.add("vcard1");
    if (card4 == 2) c4.classList.add("vcard2");
    if (card4 == 3) c4.classList.add("vcard3");
    if (card4 == 4) c4.classList.add("vcard4");
    if (card4 == 5) c4.classList.add("vcard5");
    if (card4 == 6) c4.classList.add("vcard6");
    if (card4 == 7) c4.classList.add("vcard7");
    if (card4 == 8) c4.classList.add("vcard8");
    if (card4 == 9) c4.classList.add("vcard9");
    if (card4 == 10) c4.classList.add("vcard10");
    if (card5 == 0) c5.classList.add("vcard0");
    if (card5 == 1) c5.classList.add("vcard1");
    if (card5 == 2) c5.classList.add("vcard2");
    if (card5 == 3) c5.classList.add("vcard3");
    if (card5 == 4) c5.classList.add("vcard4");
    if (card5 == 5) c5.classList.add("vcard5");
    if (card5 == 6) c5.classList.add("vcard6");
    if (card5 == 7) c5.classList.add("vcard7");
    if (card5 == 8) c5.classList.add("vcard8");
    if (card5 == 9) c5.classList.add("vcard9");
    if (card5 == 10) c5.classList.add("vcard10");
    if (card6 == 0) c6.classList.add("vcard0");
    if (card6 == 1) c6.classList.add("vcard1");
    if (card6 == 2) c6.classList.add("vcard2");
    if (card6 == 3) c6.classList.add("vcard3");
    if (card6 == 4) c6.classList.add("vcard4");
    if (card6 == 5) c6.classList.add("vcard5");
    if (card6 == 6) c6.classList.add("vcard6");
    if (card6 == 7) c6.classList.add("vcard7");
    if (card6 == 8) c6.classList.add("vcard8");
    if (card6 == 9) c6.classList.add("vcard9");
    if (card6 == 10) c6.classList.add("vcard10");
    if (card7 == 0) c7.classList.add("vcard0");
    if (card7 == 1) c7.classList.add("vcard1");
    if (card7 == 2) c7.classList.add("vcard2");
    if (card7 == 3) c7.classList.add("vcard3");
    if (card7 == 4) c7.classList.add("vcard4");
    if (card7 == 5) c7.classList.add("vcard5");
    if (card7 == 6) c7.classList.add("vcard6");
    if (card7 == 7) c7.classList.add("vcard7");
    if (card7 == 8) c7.classList.add("vcard8");
    if (card7 == 9) c7.classList.add("vcard9");
    if (card7 == 10) c7.classList.add("vcard10");
});
function cardcheck() {
...
c1.addEventListener("click", function() {
    if (k1 <= 0) {
        ...
        document.getElementById("cd2").textContent = cd4;
        if (cd3 >= cd4) score = score + (cd3 - cd4);
        else score = score - (cd4 - cd3);
        cardplay++;
